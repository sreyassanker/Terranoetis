...
export const HAZARDS = {
  ...
  earthquake: {
    ...
    coefficients: {
      caption: 'BSSA14 base-case coefficients, read from the PEER 2013/05 appendix tables (PDF archived under docs/Research papers/ as boore-2014-nga-west2-gmpe-peer-2013-05.pdf). Order e0,e1,e2,e3,e4,e5,e6,Mh,c1,c2,c3,Mref,Rref,h.',
    ...
    measured: [
      ...
      ['DOI resolvability', 'https://doi.org/10.1785/0120130065 responds 302 (resolvable) — observed 2026-09-08'],
    ],
  ...
  flood: {
    ...
    measured: [
      ...
      ['Kaggle job transport (push/poll/download)', 'VERIFIED BY CODE INSPECTION ONLY — no push was performed against the remote account in this review'],
    ],
  ...
  tsunami: {
    ...
    measured: [
      ...
      ['Kaggle job transport', 'VERIFIED BY CODE INSPECTION ONLY — no push performed in this review'],
    ],
  ...
  volcano: {
    ...
    measured: [
      ['Benchmark suite re-executed 2026-09-08 (run_benchmarks.py)', '4/4 PASS — B1 flat closed-box mass; B2 steep-terrain well-balanced mass; B3 Pinatubo 1991 ash isopach vs observed thickness–distance axes; B4 Kilauea 2018: modelled runout 15.0 km vs observed ~13.5 km, mass budget True, downslope True'],
      ...
      ['Kaggle job transport', 'VERIFIED BY CODE INSPECTION ONLY'],
    ],
  ...
  landslide: {
    ...
    measured: [
      ['Grid-convergence script re-executed 2026-09-08', 'PASS — conservation |Δ| = 0 with and without entrainment; runout 3.74→2.87→2.95 km over gs 64→128→256 (fixed 5.12 km domain, dx 80→40→20 m); area refinement Δ1 = 1.386 → Δ2 = 0.050 (gate ≤ 0.25); terrain upsample RMSE 20.6 m = 1.5 % of 1,381 m relief; exit 0'],
