...
<main id="main">
  ...
  <section class="band" id="platform" aria-labelledby="platform-h">
    ...
    <div class="showcase">
      <figure><img src="assets/showcase/multi-hazard.webp" alt="Multi-hazard risk surfaces fused from live seismic, fire, storm and flood data rendered on the 3D globe (animated)" width="640" height="400" decoding="async"><figcaption>Multi-hazard risk surfaces fused from live seismic, fire, storm and flood data.</figcaption></figure>
      <figure><img src="assets/showcase/landslide.webp" alt="Landslide debris-flow simulation over real topography, depth field animated in time steps (animated)" width="560" height="350" decoding="async"><figcaption>Landslide debris-flow simulation propagating over real topography.</figcaption></figure>
    </div>
  </section>
