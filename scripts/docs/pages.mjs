  ...
  // ════════════════════════════ ARCHITECTURE ══════════════════════════════
  {
    ...
    sections: [
      ...
      { kind: 'table', caption: 'Middleware/service order in server/index.ts (line cites are the app.use/startup sequence; boot observed 2026-09-09 on port 3399)', cols: ['Order', 'Component', 'Detail', 'Source'], rows: [
        ...
        ['8', 'DynamicToolRegistry (DB-persisted; 210 tools loaded at boot 2026-09-09) + Omninet init + local GGUF spawn', 'llama-server :11436 when model file present', src('server/index.ts', '513-817')],
